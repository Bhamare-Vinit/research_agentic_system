...
MAIN_AGENT_MAX_STEPS = read_number("MAIN_AGENT_MAX_STEPS", 8)
RETRIEVAL_TOP_K = read_number("RETRIEVAL_TOP_K", 20)
SEARCH_RESULTS_PER_QUERY = read_number("SEARCH_RESULTS_PER_QUERY", 6)
FETCH_PAGE_MAX_CHARS = read_number("FETCH_PAGE_MAX_CHARS", 15000)
